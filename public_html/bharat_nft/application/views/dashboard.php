                    ...
                    <div class="card-body">
                        ...
                        <div class="stack-box">
                            <div class="row">
                                ...
                                <div class="col-7  col-md-7">
                                    <span class="your_stake fr">0 Bharat</span>
                                ...
                                <div class="col-7  col-md-7">
                                    <span class="your_reward fr">0 ETH</span>
...
<script type="text/javascript">
    ...
    async function startStaking() {
        ...
        var userStake = user_stake + ' Bharat';
